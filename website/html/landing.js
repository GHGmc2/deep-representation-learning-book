          ...
          React.createElement('div', { className: 'section-card' },
            ...
            (function() {
              var paragraphs = getText('landing.sections.about.paragraphs', [
                ...
                'Due to the timeliness of the book, and the prevalence that deep learning may have in the coming years, we have decided to make the book completely open-source. We will update it regularly to reflect advances in the field, and welcome contributions from subject matter experts about relevant topics that we may have missed. The source code is available on [GitHub](https://github.com/Ma-Lab-Berkeley/deep-representation-learning-book). There are certainly many aspects of deep representation learning that we have not covered in this book; if you feel that something is missing, you can [let us know](https://github.com/Ma-Lab-Berkeley/deep-representation-learning-book?tab=readme-ov-file#raising-an-issue) or [contribute it yourself](https://github.com/Ma-Lab-Berkeley/deep-representation-learning-book#making-a-contribution). We will work to keep a similar standard of quality for new contributions, and recognize contributions in [the contributors page](contributors.html).'
              ]);
