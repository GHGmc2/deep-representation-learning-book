...
- [罗马尼亚语译本](../assets/book-main_ro.pdf)，由 [Piatra Institute](https://piatra.institute/) 的 Jan Cavel 贡献。
  ...
  window.showFeedbackNotice = function() {
    ...
    var title = createElement("h2", { className: "feedback-notice-title", text: "反馈指南" });
    ...
    body.innerHTML = 
      '<p>我们重视您对 BookQA AI 助手的反馈，希望了解您的使用体验！</p>' +
      '<h3>免责声明</h3>' +
      '<p>您的查询会在我们的本地服务器上匿名记录以便故障排除。为了保护您的隐私，请避免发送敏感信息。</p>' +
      '<h3>🐛 错误报告</h3>' +
      '<p>如果您在使用 AI 助手时遇到任何问题，请在我们的 GitHub 仓库中报告：</p>' +
      '<ul>' +
      '<li><a href="https://github.com/Ma-Lab-Berkeley/deep-representation-learning-book/issues" target="_blank" rel="noopener noreferrer">报告错误</a></li>' +
      '<li>包含您提出的问题和 AI 的回复</li>' +
      '<li>描述预期与实际行为的差异</li>' +
      '</ul>' +
      '<h3>💡 功能请求</h3>' +
      '<p>对改进 AI 助手有想法？我们很乐意听取您的建议：</p>' +
      '<ul>' +
      '<li><a href="https://github.com/Ma-Lab-Berkeley/deep-representation-learning-book/issues" target="_blank" rel="noopener noreferrer">提出新的议题进行讨论</a></li>' +
      '<li>建议新功能或能力</li>' +
      '<li>分享尚未得到良好支持的使用案例</li>' +
      '</ul>' +
      '<h3>📚 一般反馈</h3>' +
      '<p>对于关于本书或本网站的更广泛反馈：</p>' +
      '<ul>' +
      '<li><a href="https://github.com/Ma-Lab-Berkeley/deep-representation-learning-book#making-a-contribution" target="_blank" rel="noopener noreferrer">贡献指南</a></li>' +
      '<li>给作者发邮件（联系信息见书中）</li>' +
      '</ul>' +
      '<p><strong>感谢您帮助我们改进 BookQA AI 助手！</strong></p>';
